...
x = [0:0.1:30];
y1 = gaussian1D(x, Mean1, Std1);
y2 = gaussian1D(x, Mean2, Std2);
y3 = gaussian1D(x, Mean3, Std3);
y4 = gaussian1D(x, Mean4, Std4);
...
plot(data3, zeros(size(data3)), 'yx', 'markersize', 10);
plot(data4, zeros(size(data4)), 'gx', 'markersize', 10);
